...
#+begin_src snippet
  ...
  # --
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 0)))` 朝会[0/1]
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 0)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 0)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 1)))` 朝会[0/1]
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 1)))` SRE Tech Meeting
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))` 16:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))` 17:00] =>  1:00
  :END:
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 3)))` システム基盤定例[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 11:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 12:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 4)))` SREチーム定例MTG[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 14:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 15:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 4)))` TGIF
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 17:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 18:30] =>  1:00
  :END:
#+end_src
...
#+begin_src snippet
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 0)))` SRE Tech Meeting
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 0)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 0)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 0)))` 16:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 0)))` 17:00] =>  1:00
  :END:
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 1)))` 朝会[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 1)))`>
  :LOGBOOK:
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 2)))` システム基盤定例[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 11:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 2)))` 12:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 3)))` 朝会[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 3)))` SREチーム定例MTG[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 14:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 15:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 3)))` TGIF
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 17:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 18:30] =>  1:00
  :END:
#+end_src
...
#+begin_src snippet
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 4)))` SRE Tech Meeting
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 16:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))` 17:00] =>  1:00
  :END:
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 6)))` システム基盤定例[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 11:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 12:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
  ...
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 10:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 10:30] =>  0:30
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 7)))` SREチーム定例MTG[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 14:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 7)))` 15:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
...
#+begin_src snippet
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 3)))` SRE Tech Meeting
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 16:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 3)))` 17:00] =>  1:00
  :END:
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 4)))` 朝会[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 4)))`>
  :LOGBOOK:
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 5)))` システム基盤定例[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 11:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 5)))` 12:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 6)))` 朝会[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  ...
  :END:
  ,*** TODO 日報準備
  ,** TODO `(format-time-string "%m-%d (%a)" (time-add (current-time) (days-to-time 6)))` SREチーム定例MTG[0/1]
  SCHEDULED: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`> DEADLINE: <`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))`>
  :LOGBOOK:
  CLOCK: [`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 14:00]--[`(format-time-string "%Y-%m-%d %a" (time-add (current-time) (days-to-time 6)))` 15:00] =>  1:00
  :END:
  ,*** TODO 定例資料準備
...
** text-mode/
*** guix-commit-message-add-cl-package
#+begin_src snippet
  # -*- mode: snippet -*-
...
#+end_src
*** guix-commit-message-add-package
#+begin_src snippet
  # -*- mode: snippet -*-
...
#+end_src
*** guix-commit-message-remove-package
#+begin_src snippet
  # -*- mode: snippet -*-
...
#+end_src
*** guix-commit-message-rename-package
#+begin_src snippet
  # -*- mode: snippet -*-
...
#+end_src
*** guix-commit-message-update-package
#+begin_src snippet
  # -*- mode: snippet -*-
