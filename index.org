...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (with-eval-after-load 'dap-mode
      ;; hook
      (add-hook 'dap-mode-hook #'(lambda () (gcmh-mode -1)))))
#+end_src
** Git
*** magit
    #+BEGIN_SRC emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (with-eval-after-load 'c-mode
      (add-hook 'c-mode-hook #'puni-mode))

    (with-eval-after-load 'c++-mode
      (add-hook 'c++-mode-hook #'puni-mode))

    (with-eval-after-load 'dart-mode
      (add-hook 'dart-mode-hook #'puni-mode))

    (with-eval-after-load 'docker-compose-mode
      (add-hook 'docker-compose-mode-hook #'puni-mode))

    (with-eval-after-load 'fish-mode
      (add-hook 'fish-mode-hook #'puni-mode))

    (with-eval-after-load 'go-mode
      (add-hook 'go-mode-hook #'puni-mode))

    (with-eval-after-load 'java-mode
      (add-hook 'java-mode-hook #'puni-mode))

    (with-eval-after-load 'json-mode
      (add-hook 'json-mode-hook #'puni-mode))

    (with-eval-after-load 'js2-mode
      (add-hook 'js2-mode-hook #'puni-mode))

    (with-eval-after-load 'kotlin-mode
      (add-hook 'kotlin-mode-hook #'puni-mode))

    (with-eval-after-load 'php-mode
      (add-hook 'php-mode-hook #'puni-mode))

    (with-eval-after-load 'python-mode
      (add-hook 'python-mode-hook #'puni-mode))

    (with-eval-after-load 'typescript-mode
      (add-hook 'typescript-mode-hook #'puni-mode))

    (with-eval-after-load 'vue-mode
      (add-hook 'typescript-mode-hook #'puni-mode))

    (with-eval-after-load 'ruby-mode
      (add-hook 'ruby-mode-hook #'puni-mode))

    (with-eval-after-load 'rust-mode
      (add-hook 'rust-mode-hook #'puni-mode))

    (with-eval-after-load 'web-mode
      (add-hook 'web-mode-hook #'puni-mode))

    (with-eval-after-load 'web-php-blade-mode
      (add-hook 'web-php-blade-mode-hook #'puni-mode))

    (with-eval-after-load 'yaml-mode
      (add-hook 'yaml-mode-hook #'puni-mode))
