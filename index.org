...
#+begin_src emacs-lisp
  (eval-when-compile
    (el-clone :repo "mohkale/consult-company"))

  (with-delayed-execution
    (message "Install consult-company...")
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/consult-company"))

    (autoload-if-found '(consult-company) "consult-company" nil t)
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '(consult-projectile-switch-to-buffer
                         ...
                         consult-projectile) "consult-projectile" nil t))
#+end_src
** Refactor
*** emr
#+BEGIN_SRC emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (define-derived-mode http-mode prog-mode "http")
