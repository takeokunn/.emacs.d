...
*** flycheck
    #+begin_src emacs-lisp
      ...
      (with-delayed-execution
        ...
        (autoload-if-found '(flycheck-mode
                             flycheck-define-checker
                             flycheck-next-error
                             flycheck-previous-error
                             flycheck-list-errors) "flycheck" nil t)

        ;; keybind
        (global-set-key (kbd "C-c n") #'flycheck-next-error)
        (global-set-key (kbd "C-c n") #'flycheck-previous-error)
        (global-set-key (kbd "C-c n") #'flycheck-list-errors))
    #+end_src
*** flycheck-textlint
#+begin_src emacs-lisp
  (with-delayed-execution
...
*** company-terraform
    #+begin_src emacs-lisp
      ...
      (with-delayed-execution
        ...
        (autoload-if-found '(my/push-company-terraform) "company-terraform" nil t)
