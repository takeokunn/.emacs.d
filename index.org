...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-get/selected"))
    (autoload-if-found '(selected-global-mode) "selected" nil t)
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (with-eval-after-load 'org-roam-mode
      (add-hook 'org-roam-mode-hook #'org-roam-timestamps-mode)))
#+end_src
