...
** terraform-mode
   #+BEGIN_SRC emacs-lisp
     ...
     (with-delayed-execution
       ...
       (when (autoload-if-found '(terraform-mode terraform-format-on-save-mode) "terraform-mode" nil t)
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (push '("\\.m$" . wolfram-mode) auto-mode-alist)
    (push '("\\.nb$" . wolfram-mode) auto-mode-alist)
    (push '("\\.cbf$" . wolfram-mode) auto-mode-alist)
      ...
      (with-delayed-execution-priority-high
        ...
        (with-eval-after-load 'skk-vars
          ...
          (when (string= system-type "gnu/linux")
            (setq skk-jisyo "/home/take/.skk-jisyo.utf8"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    (message "Install apel...")
    (add-to-list 'load-path (locate-user-emacs-file "el-get/apel")))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    (message "Install flim...")
    (add-to-list 'load-path (locate-user-emacs-file "el-get/flim")))
#+end_src
*** semi
#+begin_src emacs-lisp
  (eval-when-compile
  ...
  (with-delayed-execution
    (message "Install semi...")
    (add-to-list 'load-path (locate-user-emacs-file "el-get/semi")))
...
*** wanderlust
    #+begin_src emacs-lisp
      ...
      ;;   (add-to-list 'load-path (locate-user-emacs-file "el-get/wanderlust/wl"))
      ;;   (add-to-list 'load-path (locate-user-emacs-file "el-get/wanderlust/elmo"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '(macrostep-mode) "macrostep" nil t)
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '(composer
                         ...
                         composer-view-lock-file) "composer" nil t))
...
#+begin_src emacs-lisp
  (with-delayed-execution
    ...
    (autoload-if-found '(org-roam-db-autosync-mode) "org-roam-db" nil t)
...
#+begin_src emacs-lisp
  ...
  (when (string= system-type "gnu/linux")
    (with-delayed-execution
      ...
      (autoload-if-found '(exwm-systemtray-enable) "exwm-systemtray" nil t)
      (autoload-if-found '(exwm-config-example) "exwm-config" nil t)
