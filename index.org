...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '() "dired-collapse" nil t))
#+end_src
*** dired-filter
#+begin_src emacs-lisp
  (eval-when-compile
...
#+begin_src emacs-lisp
  (eval-when-compile
    (el-get-bundle 'dired-git-info))

  (with-delayed-execution
    (message "Install dired-git-info...")
    (add-to-list 'load-path (locate-user-emacs-file "el-get/dired-git-info"))
    (autoload-if-found '(dired-git-info-mode) "dired-git-info" nil t)
    (with-eval-after-load 'dired
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '() "dired-open" nil t))
#+end_src
*** dired-ranger
#+begin_src emacs-lisp
  (eval-when-compile
