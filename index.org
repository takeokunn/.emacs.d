...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    (message "Install company-solidity...")
    (add-to-list 'load-path (locate-user-emacs-file "el-get/company-solidity"))
    (autoload-if-found '(company-solidity) "company-solidity" t)
    (with-eval-after-load 'company
