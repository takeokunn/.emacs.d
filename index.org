...
** emmet-mode
   #+BEGIN_SRC emacs-lisp
     (leaf emmet-mode
       :ensure t
       :after vue-mode web-mode
       :bind (("C-j" . nil))
       :hook (web-mode-hook vue-mode))
   #+END_SRC
** fish-mode
   #+BEGIN_SRC emacs-lisp
     (leaf fish-mode
...
*** neotree
    #+BEGIN_SRC emacs-lisp
      (leaf neotree
        :ensure t
        :preface
        (defun takeokunn/neotree-toggle nil
          (interactive)
...
*** ivy-ghq
    #+BEGIN_SRC emacs-lisp
      (leaf ivy-ghq
        :el-get (ivy-ghq :url "https://raw.githubusercontent.com/analyticd/ivy-ghq.git")
        :preface
        (defun takeokunn/ivy-ghq-open-and-fzf nil
          (interactive)
          (ivy-ghq-open)
          (counsel-fzf))
        :after counsel
    ...
    #+begin_src emacs-lisp
      (leaf helm
        ...
        (leaf helm-swoop
          ...
          :bind
          ("C-o" . heml-swoop)
          :bind (helm-swoop-map  ("C-o" . helm-swoop))
          :custom (helm-swoop-split-direction 'split-window-vertically)))
    #+end_src
** Shell
*** aweshell
    #+BEGIN_SRC emacs-lisp
      ;; (leaf aweshell :ensure t)
    #+END_SRC
...
*** tide
    #+BEGIN_SRC emacs-lisp
      (leaf tide
        ...
        :config
        (eval-and-compile
          (defun takeokunn/setup-tide-mode nil
            (interactive)
            (tide-setup)
...
** Keybind
   #+BEGIN_SRC emacs-lisp
     ...
     (general-def org-mode-map "\C-m" nil)
   #+END_SRC
