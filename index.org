...
** time locale
   ...
   #+END_SRC
** TODO Font
ref: https://qiita.com/kawabata@github/items/2c4b0b689834c9c193aa
   #+BEGIN_SRC emacs-lisp
...
*** open-junk-file
    #+BEGIN_SRC emacs-lisp
      ...
      (with-delayed-execution
        ...
        (when (autoload-if-found '(my/open-junk-file) "open-junk-file" nil t)
          (defun my/open-junk-file ()
            ...
            (let ((default-directory (format-time-string "~/.emacs.d/.junk/%Y-%m%d-%H%M%S." (current-time))))
              (open-junk-file))
            (ivy-mode 1))
          (global-set-key (kbd "C-c j") 'my/open-junk-file)
          (eval-and-compile
