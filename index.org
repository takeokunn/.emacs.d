...
#+BEGIN_SRC emacs-lisp
  ...
  (with-delayed-execution-priority-high
    ...
    (with-eval-after-load 'skk
      ...
      ;; keybind
      (define-key skk-latin-mode-map (kbd "C-h") #'delete-char)
      (define-key skk-j-mode-map (kbd "C-h") #'delete-char)
      (define-key skk-jisx0208-latin-mode-map (kbd "C-h") #'delete-char)
      (define-key skk-abbrev-mode-map (kbd "C-h") #'delete-char))
