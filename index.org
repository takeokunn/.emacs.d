...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution-priority-high
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/async")))
#+end_src
** bui
#+begin_src emacs-lisp
  (eval-when-compile
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution-priority-high
   (message "Install eplert-expectations...")
   (add-to-list 'load-path (locate-user-emacs-file "el-clone/eplert-expectations")))
#+end_src
** espuds
#+begin_src emacs-lisp
  (eval-when-compile
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution-priority-high
   ...
   (add-to-list 'load-path (locate-user-emacs-file "el-clone/treemacs")))
#+end_src
** treepy
#+begin_src emacs-lisp
  (eval-when-compile
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/bazel-mode"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/cfn-mode"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/crystal-mode"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/dotenv-mode"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/ninja-mode"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/nov-mode"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/scala-mode"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/company-terraform"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/forge"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/ddskk-postframe"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/lorem-ipsum"))
...
#+begin_src emacs-lisp
  ;; (eval-when-compile
  ;;   (el-clone :url "https://codeberg.org/rgherdt/emacs-lsp-scheme.git"))
...
#+begin_src emacs-lisp
  (eval-when-compile
    (el-clone :repo "koron/cmigemo"))

  (with-delayed-execution
    (message "Install migemo...")
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/cmigemo"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/dashboard"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/htmlize"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/rubocop"))
...
#+BEGIN_SRC emacs-lisp
  (eval-when-compile
    (el-clone :repo "bzg/org-mode"))

  (with-eval-after-load 'org
    (message "Install org...")
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/org-mode"))
