...
*** neotree
    #+BEGIN_SRC emacs-lisp
      ...
      (with-delayed-execution-priority-high
        ...
        (autoload-if-found '(my/neotree-toggle neotree-hide neotree-dir) "neotree" nil t)
...
*** inf-ruby
    #+BEGIN_SRC emacs-lisp
      ...
      (with-delayed-execution
        ...
        (when (autoload-if-found '(inf-ruby inf-ruby-minor-mode my/irb-history) "inf-ruby" nil t)
...
** org-generate
   #+begin_src emacs-lisp
     ...
     (with-delayed-execution
       ...
       (autoload-if-found '(my/org-generate org-generate) "org-generate" nil t)
