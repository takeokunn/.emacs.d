...
#+begin_src emacs-lisp
  (eval-when-compile
    (el-clone :repo "karthink/gptel"))

  (with-delayed-execution
    (message "Install gptel...")
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/gptel")))
#+end_src
** helm
#+begin_src emacs-lisp
  (eval-when-compile
...
#+begin_src emacs-lisp
  (eval-when-compile
    (el-clone :repo "douo/magit-gptcommit"))

  (with-delayed-execution
    (message "Install magit-gptcommit...")
    (add-to-list 'load-path (locate-user-emacs-file "el-clone/magit-gptcommit"))
...
#+begin_src emacs-lisp
  (with-delayed-execution
    ...
    (add-to-list 'load-path (locate-user-emacs-file "/nix/store/iyqr1hy0195pzvd4rmn9cz5hxmzqj42j-emacs-mu4e-1.12.5/share/emacs/site-lisp/elpa/mu4e-1.12.5"))
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    ;; (with-eval-after-load 'mu4e-view
    ;;   (setopt mu4e-views-completion-method 'ivy)
    ;;   (setopt mu4e-views-default-view-method "html")
    ;;   (setopt mu4e-views-next-previous-message-behaviour 'stick-to-current-window)
    ;;   (setopt mu4e-views-auto-view-selected-message t))
    )
#+end_src
*** mu4e-dashboard
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  ;;     (setopt migemo-dictionary "~/.nix-profile/share/migemo/utf-8/migemo-dict")
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;      (setopt slime-path `,(expand-file-name "swank-loader.lisp" (my/roswell-directory "slime")))
  ;;      (setopt slime-backend `,(expand-file-name "swank-loader.lisp" (my/roswell-directory "slime")))
  ;;      (setopt inferior-lisp-program "ros -Q run")))
...
#+begin_src emacs-lisp
  (with-delayed-execution
    ...
    (with-eval-after-load 'hyperspec
      (setopt common-lisp-hyperspec--reader-macros nil)
      (setopt common-lisp-hyperspec--format-characters nil))
