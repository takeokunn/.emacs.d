   ...
   #+BEGIN_SRC emacs-lisp
     (leaf vue-mode
       ...
       (with-eval-after-load 'vue-mode
         (setq mmm-js-mode-enter-hook (lambda nil
                                        (setq syntax-ppss-table nil)))
         (setq mmm-typescript-mode-enter-hook (lambda nil
                                                (setq syntax-ppss-table nil)))
...
*** slime-company
    #+BEGIN_SRC emacs-lisp
      (leaf slime-company
        :ensure t
        :after company slime
        :setq ((slime-company-completion quote fuzzy)
...
*** counsel
	...
	:setq ((ivy-use-virtual-buffers . t)
	       (counsel-ag-base-command . "ag --nocolor --nogroup -u %s"))
	:config
	(ivy-mode 1)
	(counsel-mode 1))
    #+END_SRC
...
*** ruby-refactor
    #+BEGIN_SRC emacs-lisp
      (leaf ruby-refactor
	:ensure t
Process *esup-child* abort trap: 6
...
*** helpful
	...
	(("C-? f" . helpful-callable)
	 ...
	 ("C-? C" . helpful-command))
	:setq ((counsel-describe-function-function function helpful-callable)
