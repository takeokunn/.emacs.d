...
#+begin_src emacs-lisp
  ...
  ;;   (when (autoload-if-found '(company-phpactor) "company-phpactor" nil t)
  ;;     (add-hook 'php-mode-hook #'(lambda ()
  ;;                                  (push '(company-phpactor company-files) company-backends))))
  ;;   (when (autoload-if-found '(phpactor-goto-definition phpactor-find-references) "phpactor" nil t)
  ;;     (add-hook 'php-mode-hook #'lsp-deferred)
  ;;     (with-eval-after-load 'phpactor
