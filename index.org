    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (with-delayed-execution-priority-high
        ...
        (with-eval-after-load 'exec-path-from-shell
          (eval-and-compile
            (setq exec-path-from-shell-variables '("PATH" "GEM_HOME" "GOROOT" "GOPATH" "LSP_USE_PLISTS" "JAVA_HOME" "JAVA_CMD")))))
    #+END_SRC
** Cpp
*** clang-format
    #+begin_src emacs-lisp
...
** elfeed
   #+begin_src emacs-lisp
     ...
     (with-delayed-execution
       ...
       (when (autoload-if-found '(elfeed my/elfeed-ivy-filter) "elfeed" nil t)
