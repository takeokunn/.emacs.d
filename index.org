...
#+begin_src emacs-lisp
  (with-eval-after-load 'comp
    (setq native-comp-async-jobs-number 10)
...
#+begin_src emacs-lisp
  (with-eval-after-load 'files
    (setq safe-local-variable-values '(testing . "yes")))
#+end_src
...
*** projectile
    #+begin_src emacs-lisp
      ...
      (with-delayed-execution-priority-high
        ...
        (autoload-if-found '(projectile-mode my/update-projectile-known-projects) "projectile" nil t)
        (projectile-mode +1)
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (autoload-if-found '(global-key-combo-mode key-combo-define-local) "key-combo" nil t)
...
#+begin_src emacs-lisp
  ...
  (with-delayed-execution
    ...
    (with-eval-after-load 'view-lock-mode
      (setq view-lock-start-time (* 10 60))))
#+end_src
*** which-key
    #+begin_src emacs-lisp
      (eval-when-compile
